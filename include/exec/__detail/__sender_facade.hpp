    ...
    template <class _Kernel, class _Sender, class _Env>
      auto __transform_sender_t_() {
        if constexpr (__lacks_transform_sender<_Kernel>) {
          ...
          if constexpr (__valid_<__tfx_sender_, _Kernel, _Sender, _Env>) {
      ...
      struct __receiver {
        ...
        struct __t {
          ...
          template <__one_of<set_value_t, set_error_t, set_stopped_t> _Tag,
                    same_as<__t> _Self,
                    class... _As>
              requires __valid_<__set_result_t, _Kernel, _Receiver, _Tag, _As...>
          ...
          template <class _Self, class _Env>
            static auto __impl() {
              ...
              if constexpr (sender<_NewSender>) {
                ...
                if constexpr (__valid_<__pre_completions_t, _NewSender, _NewEnv>) {
                  using _Completions =
